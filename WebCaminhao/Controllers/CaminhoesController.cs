...
namespace WebCaminhao.Controllers
{
    ...
    public class CaminhoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCaminhao,Descricao,Modelo,AnoModelo,AnoFabricacao")] Caminhao caminhao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCaminhao,Descricao,Modelo,AnoModelo,AnoFabricacao")] Caminhao caminhao)
        {
